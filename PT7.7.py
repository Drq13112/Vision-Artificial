...
circunferencia interna de una brida.
...
img = cv2.imread('../imagenes/chaveta05.png',0)
...
#y así poder sacar su contorno con facilidad.
#No obstante al hacer esto voy a detectar el fondo y el circulo del interior, 
#luego hay que descartar el fondo.
...
for i in range(1,num_labels):
     ...
     img_aux[img_labels == i] = 255
    
     #Busco los contornos de la imagen
     #En este caso voy a encontrar dos contornos, el fondo y el interior del circulo
     ...
     for j in range(len(contours)):
        ...
        if perimeter<900:
            ...
            #cogemos los puntos del contorno interno de la chaveta
            ptos_contornos=cnt
